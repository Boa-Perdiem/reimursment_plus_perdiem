...
reimb_req_pdf_bp = Blueprint("reimb_req_pdf", __name__, url_prefix="/reimb_req_pdf")

@reimb_req_pdf_bp.route("/perdiem/<int:request_id>")
@login_required
def generate_req_trueperdiem_pdf(request_id):
    ...
    base_pdf = PdfReader(BytesIO(perdiem.reimburs_form))  #
