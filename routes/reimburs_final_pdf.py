...
reimburs_final_pdf_bp = Blueprint("reimburs_final_pdf", __name__, url_prefix="/reimburs_final_pdf")

@reimburs_final_pdf_bp.route("/perdiem/<int:request_id>")
@login_required
def generate_reimb_final_pdf(request_id):
    ...
    if u_role in ["MANAGERIAL_APPROVER", "FINAL_APPROVER", "MANAGERIAL_DELEGATE"]:
